...
from TAD66K.data.dataset import TAD66KDataset
...
for epoch in range(num_epochs):
    ...
    if new_lr < 1e-5: # minimum learning rate reached, stop training
        logging.info(f"Learning rate reached minimum value {new_lr}, stopping training!")
        break
    if old_lr != new_lr:
